...
module hunt.stomp.simp.config.MessageBrokerRegistry;

// import hunt.framework.context.event.SmartApplicationListener;
import hunt.stomp.simp.config.ChannelRegistration;
import hunt.stomp.simp.config.StompBrokerRelayRegistration;
import hunt.stomp.simp.config.SimpleBrokerRegistration;
...
class MessageBrokerRegistry {
	 ...
	 * {@link hunt.stomp.simp.user.SimpUserRegistry
	 ...
	 * @since 4.3.2
	 * @see hunt.stomp.simp.broker.DefaultSubscriptionRegistry#setCacheLimit
	 */
